...
/usr/local/bin/patch -R "$srctopatch/dom/ipc/ContentChild.cpp" "$w3credentials/ContentChild.cpp-patch"
/usr/local/bin/patch -R "$srctopatch/dom/ipc/ContentChild.h" "$w3credentials/ContentChild.h-patch"
